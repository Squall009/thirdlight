...
| 07 | Durable workspace service | B | 06 | implemented 2026-09-18: `packages/workspace` on the real FS (full §6.1 pipeline, ownership/takeover/release, durable retry records, atomic W + verification, recovery snapshots, scan/§8.3 completion, external-change pause/resolve); 52 new real tests (fixture-pinned scenarios 01–05/08/09, fault injection, 3 real-SIGKILL crash tests incl. second live backend via real /proc); all gates green (438/438); **Gate B ready for review** (commit ID recorded by follow-up) | docs/handoffs/07.md |
