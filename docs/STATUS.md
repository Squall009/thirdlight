...
| 4 | Beacon Reach is honestly playable in editor and export | D10–D13, D20, D28–D30; sample loadable through the backend | mostly done 2026-09-22 — templates via `POST /admin/projects {template}`; visible animated courier; goal cue; checkpoint glow; fixed GLB; Play works for games in the editor; e2e plays it to the goal through the relays, keyboard drives it in preview and export. Open: behaviors in the game host (D12); owner playthrough by hand |
