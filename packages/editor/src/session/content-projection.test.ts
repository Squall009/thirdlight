...
describe('packet 27 — content projection (sessions.md §8/§19.4)', () => {
  ...
  it('reports unresolved placement references instead of merging partial state', () => {
    ...
    const entities: ProjectedEntity[] = [
      { id: 'model-0001', name: 'a', parentId: null, kind: 'model', active: true, locked: false, static: false, position: [0, 0, 0], rotation: [0, 0, 0, 1], scale: [1, 1, 1], assetId: 'asset-0001' },
      { id: 'model-0002', name: 'b', parentId: null, kind: 'model', active: true, locked: false, static: false, position: [0, 0, 0], rotation: [0, 0, 0, 1], scale: [1, 1, 1], assetId: 'asset-gone' },
    ];
