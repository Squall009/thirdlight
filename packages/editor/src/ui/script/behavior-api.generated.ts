...
export const BEHAVIOR_API_TYPES: Readonly<Record<string, readonly BehaviorApiMember[]>> = {
  "ActionFrame": [
    ...
    },
    {
      "name": "commands",
      "kind": "property",
      "detail": "readonly DebugCommandCall[] | undefined",
      "optional": true,
      "doc": "Phase 23.8, optional: the debug commands run in this step (a tool, the in-game console) — part of the input so a recording replays them exactly. Absent: none (every older frame and recording is unchanged)."
    }
  ],
  ...
  "BehaviorCamera": [
    {
      "name": "activate",
      "kind": "method",
      "detail": "(cameraId: string, options?: CameraBlendOptions | undefined): boolean",
      "doc": "Enable a virtual camera and bring it in front of the cameras of its priority (it goes live unless a higher priority is enabled). `false` when there is no such camera."
    },
    {
      "name": "deactivate",
      "kind": "method",
      "detail": "(cameraId: string, options?: CameraBlendOptions | undefined): boolean",
      "doc": "Disable a virtual camera (the view blends to the next one, or back to the scene camera)."
    },
    {
      "name": "setPriority",
      "kind": "method",
      "detail": "(cameraId: string, priority: number): boolean",
      "doc": "Set a camera's priority (−1000–1000; the enabled camera with the highest is live)."
    },
    {
      "name": "setTarget",
      "kind": "method",
      "detail": "(cameraId: string, entityId: string): boolean",
      "doc": "Point a camera at another target entity ('' for none)."
    },
    {
      "name": "set",
      "kind": "method",
      "detail": "(cameraId: string, params: { distance?: number | undefined; yaw?: number | undefined; pitch?: number | undefined; progress?: number | undefined; railSpeed?: number | undefined; fovY?: number | undefined; letterbox?: number | undefined; point?: readonly number[] | undefined; targetOffset?: readonly number[] | undefined; }): boolean",
      "doc": "Set a camera's rig values (each optional): distance, yaw, pitch (kept within its pitch limits), progress and railSpeed of a rail camera, field of view, letterbox, the orbit point, the target offset."
    },
    {
      "name": "turn",
      "kind": "method",
      "detail": "(cameraId: string, steps: number): boolean",
      "doc": "Turn a camera by whole steps (an orbit-a-point camera: its turn step; positive turns left)."
    },
    {
      "name": "shake",
      "kind": "method",
      "detail": "(amplitude: number, seconds: number, frequency?: number | undefined, rotation?: number | undefined, seed?: number | undefined): void",
      "doc": "Shake the view: up to `amplitude` metres (and `rotation` degrees), `frequency` times a second (default 8), fading out over `seconds`. Seeded: the same run shakes the same way (`seed` picks another pattern)."
    },
    {
      "name": "live",
      "kind": "method",
      "detail": "(): string | null",
      "doc": "The live virtual camera, or null while the scene camera shows its own view."
    },
    {
      "name": "blending",
      "kind": "method",
      "detail": "(): boolean",
      "doc": "A blend between two cameras is in progress."
    },
    {
      "name": "get",
      "kind": "method",
      "detail": "(cameraId: string): BehaviorCameraState | null",
      "returns": "BehaviorCameraState",
      "doc": "A virtual camera's live rig values, or null when there is no such camera."
    },
    {
      "name": "worldToScreen",
      "kind": "method",
      "detail": "(position: readonly number[]): { x: number; y: number; depth: number; onScreen: boolean; }",
      "returns": "BehaviorCamera.worldToScreen()",
      "doc": "Where a world point appears on screen (x, y 0–1 from the top left), how far in front of the camera it is, and whether it is in view."
    },
    {
      "name": "screenToRay",
      "kind": "method",
      "detail": "(x: number, y: number): { origin: readonly [number, number, number]; direction: readonly [number, number, number]; }",
      "returns": "BehaviorCamera.screenToRay()",
      "doc": "The ray from the camera through a screen point (x, y 0–1 from the top left): its origin and unit direction."
    }
  ],
  "BehaviorCamera.screenToRay()": [
    {
      "name": "origin",
      "kind": "property",
  ...
  "BehaviorCameraState": [
    {
      "name": "rig",
      "kind": "property",
      "detail": "'follow' | 'orbitPoint' | 'topDown' | 'fixed' | 'rail'"
    },
    {
      "name": "enabled",
      "kind": "property",
    ...
    },
    {
      ...
      "kind": "property",
      "detail": "boolean",
      "doc": "It is the live camera."
    },
    {
      "name": "target",
      "kind": "property",
      "detail": "string",
      "doc": "The target entity ('' for none)."
    },
    {
      "name": "distance",
      "kind": "property",
    ...
    },
    {
      ...
      "kind": "property",
      "detail": "number",
      "doc": "Degrees (a snapped rig: the step it turns to)."
    },
    {
      "name": "pitch",
      "kind": "property",
    ...
    },
    {
      ...
      "kind": "property",
      "detail": "number",
      "doc": "A rail camera's place along its path (0–1)."
    },
    {
      "name": "railSpeed",
      "kind": "property",
  ...
  "BehaviorContext": [
    ...
    },
    {
      "name": "random",
      "kind": "property",
      "detail": "BehaviorRandom",
      "type": "BehaviorRandom",
      "doc": "Phase 23.7: seeded random numbers of this instance (replay-safe; the project's `random_seed` setting with this script and object), with named sub-streams."
    },
    {
      "name": "signals",
      "kind": "property",
    ...
    },
    {
      "name": "effects",
      "kind": "property",
      "detail": "BehaviorEffects | undefined",
      "type": "BehaviorEffects",
      "optional": true,
      "doc": "Play visual effects (presentation only, never part of the simulation)."
    },
    {
      "name": "save",
      "kind": "property",
    ...
    },
    {
      "name": "debug",
      "kind": "property",
      "detail": "BehaviorDebug | undefined",
      "type": "BehaviorDebug",
      "optional": true,
      "doc": "Phase 23.8: project debug commands (run by tools and the in-game console, recorded with the input)."
    },
    {
      "name": "spawn",
      "kind": "method",
    ...
    },
    {
      "name": "camera",
      "kind": "property",
      "detail": "BehaviorCamera | undefined",
      "type": "BehaviorCamera",
      "optional": true,
      "doc": "Phase 23.4: the virtual cameras — activate, priorities, rig values, shake, screen↔world."
    }
  ],
  "BehaviorDebug": [
    {
      "name": "command",
      "kind": "method",
      "detail": "(name: string, options?: DebugCommandOptions | undefined, handler?: ((args: Readonly<Record<string, DebugCommandArg>>) => void) | undefined): readonly Readonly<Record<string, DebugCommandArg>>[]",
      "doc": "Declare the debug command `name` (the first declaration fixes its arguments; calling it again every step is how a script listens) and get the calls made to it in this step — in the `intent` phase; the other phases see none. With `handler`, "
    }
  ],
  "BehaviorEffects": [
    {
      "name": "play",
      "kind": "method",
      "detail": "(effectId: string, options?: { position?: readonly number[] | undefined; entityId?: string | undefined; params?: Readonly<Record<string, string | number | readonly number[]>> | undefined; } | undefined): number",
      "doc": "Play a project effect (particles) once: on `entityId` (it follows the object; `position` is then an offset from it) or, without one, at `position` in world metres. `params` override its public parameters. Returns a handle for `stop`, or 0 w"
    },
    {
      "name": "stop",
      "kind": "method",
      "detail": "(target: string | number): void",
      "doc": "Stop spawning: a play's handle, or an object's id (every effect playing on it, its effect component included). Living particles finish their lives."
    }
  ],
  "BehaviorGameState": [
    {
  ...
  "BehaviorRandom": [
    {
      "name": "stream",
      "kind": "method",
      "detail": "(name: string): BehaviorRandomStream",
      "returns": "BehaviorRandomStream",
      "doc": "An independent named stream of this object (the same name gives the same stream): draws from one never shift the numbers of another, so adding a draw for loot does not change the numbers used for movement. Names: 1–64 characters of letters,"
    },
    {
      "name": "next",
      "kind": "method",
      "detail": "(): number",
      "doc": "A number in [0, 1) (a multiple of 2^-32)."
    },
    {
      "name": "range",
      "kind": "method",
      "detail": "(min: number, max: number): number",
      "doc": "A number in [min, max)."
    },
    {
      "name": "int",
      "kind": "method",
      "detail": "(min: number, max: number): number",
      "doc": "A whole number from `min` to `max`, both included (the bounds are rounded inward)."
    },
    {
      "name": "chance",
      "kind": "method",
      "detail": "(p: number): boolean",
      "doc": "True with probability `p` (0: never, 1: always)."
    },
    {
      "name": "pick",
      "kind": "method",
      "detail": "<T>(list: readonly T[]): T | undefined",
      "doc": "One item of `list` chosen evenly, or `undefined` when it is empty."
    }
  ],
  ...
  "BehaviorWorldView": [
    ...
    },
    {
      ...
      "doc": "Phase 23.7: the first loaded entity whose name is exactly `name` (case-sensitive), or `undefined`. Entities are searched in load order: the start scene in document order, then later scenes and spawned copies as they arrived."
    },
    {
      "name": "findAll",
      "kind": "method",
      "detail": "(name: string): readonly string[]",
      "doc": "Phase 23.7: every loaded entity whose name is exactly `name` (case-sensitive), in load order (spawned copies included)."
    },
    {
      "name": "withComponent",
      "kind": "method",
      "detail": "(kind: string): readonly string[]",
      "doc": "Phase 23.7: every loaded entity carrying a component of this kind (as stored on the entity, e.g. `'collider'`, `'light'`, `'behavior'`), in load order (spawned copies included)."
    }
  ],
  "CharacterMoveResult": [
    {
  ...
  "Readonly<GameplaySettings>": [
    ...
    },
    {
      ...
      "detail": "number | undefined",
      "optional": true,
      "doc": "Phase 22.0: where the simulation runs in Play and the export (1 a worker, 2 the page's main thread; absent: 1)."
    }
  ],
